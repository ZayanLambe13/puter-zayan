...
* add alarms to meteringService if cost for service is unexpectedly 0 ([#1755](https://github.com/ZayanLambe13/puter-zayan/issues/1755)) ([7e8842e](https://github.com/ZayanLambe13/puter-zayan/commit/7e8842e35d73cea1afbda7127546b620fbb12feb))
* add expiry support to DBKV, and eslint config ([f8ea790](https://github.com/ZayanLambe13/puter-zayan/commit/f8ea79082423a3d90031b1a85a59514b224e149e))
* add missing Persian and Finnish translations ([#1614](https://github.com/ZayanLambe13/puter-zayan/issues/1614)) ([b8263fd](https://github.com/ZayanLambe13/puter-zayan/commit/b8263fd8e009f4d44ad41e788485f48ff81898e5))
* Add missing Portuguese translations ([#1615](https://github.com/ZayanLambe13/puter-zayan/issues/1615)) ([1cff4fd](https://github.com/ZayanLambe13/puter-zayan/commit/1cff4fd46a5489565f5dd7dffeb6f92a8f117989))
* Add missing Urdu translations ([#1618](https://github.com/ZayanLambe13/puter-zayan/issues/1618)) ([72ee05f](https://github.com/ZayanLambe13/puter-zayan/commit/72ee05fefbc3da7b3fd2a0e81f1b95d10f64abeb))
* Add missing Vietnamese translations ([#1641](https://github.com/ZayanLambe13/puter-zayan/issues/1641)) ([a17ab22](https://github.com/ZayanLambe13/puter-zayan/commit/a17ab22ab7758e8469f87afdcdf871b8f0b05fef))
* add OpenAI support to text-to-speech ([#1853](https://github.com/ZayanLambe13/puter-zayan/issues/1853)) ([861aedd](https://github.com/ZayanLambe13/puter-zayan/commit/861aeddf3ec1c90b6ba4fdef3df71ef8bf34507d))
* add openrouter metering ([#1724](https://github.com/ZayanLambe13/puter-zayan/issues/1724)) ([248b199](https://github.com/ZayanLambe13/puter-zayan/commit/248b199fa356653533a1adf092a194b90ad8c98a))
* add optional dotenv support ([15eb44d](https://github.com/ZayanLambe13/puter-zayan/commit/15eb44d62df189afb20bd2bd6549f711cdfe69bf))
* add optional input image fields to AIInterfaceService ([eb53b86](https://github.com/ZayanLambe13/puter-zayan/commit/eb53b86c8ad52cde72b0d0dc34e02d859c83c132))
* add speech2text ([#1855](https://github.com/ZayanLambe13/puter-zayan/issues/1855)) ([64f86da](https://github.com/ZayanLambe13/puter-zayan/commit/64f86daddb8afb80980f35fc5f40a2974e1b7648))
* add support for image-to-image generation in GeminiImageGenerationService ([f4fc24b](https://github.com/ZayanLambe13/puter-zayan/commit/f4fc24bce32d5af5aae282f0505d53816d9eeddd))
* add tar and untar functionality for file management ([343f042](https://github.com/ZayanLambe13/puter-zayan/commit/343f042f391b79877f8268176910475443906558))
* alert when going over usage limits significantly + egress metering ([#1782](https://github.com/ZayanLambe13/puter-zayan/issues/1782)) ([27f2411](https://github.com/ZayanLambe13/puter-zayan/commit/27f24118f34129e4083d4ba10b6d57fce4456593))
* allow for unlimitedAllowList + typedefs snuck in by accident ([#1813](https://github.com/ZayanLambe13/puter-zayan/issues/1813)) ([219fd22](https://github.com/ZayanLambe13/puter-zayan/commit/219fd2274cbf71aeeb3744810c3a26cbbc880b3f))
* allow setting puter origin via globalThis variables ([bf76a1e](https://github.com/ZayanLambe13/puter-zayan/commit/bf76a1edea1a8b0fcd66181e52a454a7f6581889))
* Complete missing Ukrainian, Turkish and Thai translations ([#1616](https://github.com/ZayanLambe13/puter-zayan/issues/1616)) ([733c7b6](https://github.com/ZayanLambe13/puter-zayan/commit/733c7b638d0d9bfefbfdc72ed08eccfbd89fc81c))
* DAV Locks support + refactor of DAV method handler ([#1486](https://github.com/ZayanLambe13/puter-zayan/issues/1486)) ([d70d412](https://github.com/ZayanLambe13/puter-zayan/commit/d70d4121158547b3217664da498d2bcdae0a73c0))
* devCenter open ui message ([#1850](https://github.com/ZayanLambe13/puter-zayan/issues/1850)) ([0bb1426](https://github.com/ZayanLambe13/puter-zayan/commit/0bb14261c2e0c7cc69ea0a03b367fefa01334d7f))
* enforce new metering + get rid of old methods ([#1762](https://github.com/ZayanLambe13/puter-zayan/issues/1762)) ([08e26af](https://github.com/ZayanLambe13/puter-zayan/commit/08e26af85d5aa620a525fb9534766f04a1ae5e14))
* extract and centralize cost maps ([#1691](https://github.com/ZayanLambe13/puter-zayan/issues/1691)) ([f06bec4](https://github.com/ZayanLambe13/puter-zayan/commit/f06bec4cd482ae9e494704667d6ab036988411a4))
* **i18n:** add missing Hindi translations ([#1525](https://github.com/ZayanLambe13/puter-zayan/issues/1525)) ([#1534](https://github.com/ZayanLambe13/puter-zayan/issues/1534)) ([3f746b9](https://github.com/ZayanLambe13/puter-zayan/commit/3f746b94de6ca6b500354be214e489a5d04dea0b))
* immprove `UIPopover` and `UIWindow` behavior for sidepanel visibility ([#1711](https://github.com/ZayanLambe13/puter-zayan/issues/1711)) ([64cfa81](https://github.com/ZayanLambe13/puter-zayan/commit/64cfa8158d33018233aa06ff8ad3763ae443d6f3))
* improve image generation and coercion for data URLs ([4e8aad6](https://github.com/ZayanLambe13/puter-zayan/commit/4e8aad675db7ac69182b252f1d855daa63696268))
* initial metering service supporting monthly tracking of service consumption ([#1630](https://github.com/ZayanLambe13/puter-zayan/issues/1630)) ([cc3b0db](https://github.com/ZayanLambe13/puter-zayan/commit/cc3b0db6b1b0ca27a55b7f463674e0a3cc3377f3))
* introduce `PANEL_WIDTH` constant and refactor `UIWindow` for panel handling ([#1780](https://github.com/ZayanLambe13/puter-zayan/issues/1780)) ([eb123d8](https://github.com/ZayanLambe13/puter-zayan/commit/eb123d873f311374c4d5068ec898ad419a430496))
* limit alerting ([#1798](https://github.com/ZayanLambe13/puter-zayan/issues/1798)) ([6bbd9bd](https://github.com/ZayanLambe13/puter-zayan/commit/6bbd9bdc9f367ef260e8620673ebc7418f89bcd7))
* logging for queries in puter js ([caa383d](https://github.com/ZayanLambe13/puter-zayan/commit/caa383d5cd966b07238478ba5f889bc65b1760c8))
* manage permission for user to user and dev to app file sharing ([#1567](https://github.com/ZayanLambe13/puter-zayan/issues/1567)) ([d9c64a9](https://github.com/ZayanLambe13/puter-zayan/commit/d9c64a93783dad59fb7a47a7be48f72ba4b4e272))
* meter claude ai ([#1716](https://github.com/ZayanLambe13/puter-zayan/issues/1716)) ([73a24af](https://github.com/ZayanLambe13/puter-zayan/commit/73a24af9516ddcca28efe1ccd09b638b7957730f))
* meter ll_read for the person reading ([#1854](https://github.com/ZayanLambe13/puter-zayan/issues/1854)) ([62b6582](https://github.com/ZayanLambe13/puter-zayan/commit/62b6582d854d48be8664edaf6a1868ed059562f4))
* meter open ai ([#1703](https://github.com/ZayanLambe13/puter-zayan/issues/1703)) ([0acb884](https://github.com/ZayanLambe13/puter-zayan/commit/0acb884ed0d5b63b009a8169121640cb6256425e))
* metering service allowence checks and subscription integration 🚀  ([#1749](https://github.com/ZayanLambe13/puter-zayan/issues/1749)) ([e51d0c4](https://github.com/ZayanLambe13/puter-zayan/commit/e51d0c460044bf3a390f2b2bd5a916b2c0ea8caf))
* purchase addons logic in metering ([#1765](https://github.com/ZayanLambe13/puter-zayan/issues/1765)) ([b7cee87](https://github.com/ZayanLambe13/puter-zayan/commit/b7cee8737073cdfef62df7ea13f16acfdec0e3b1))
* rename meteringAndBilling to metering ([#1800](https://github.com/ZayanLambe13/puter-zayan/issues/1800)) ([16fd614](https://github.com/ZayanLambe13/puter-zayan/commit/16fd614b8486737154d4cc3b12a40e55942f511d))
* route for global usage aggregate ([#1810](https://github.com/ZayanLambe13/puter-zayan/issues/1810)) ([256189a](https://github.com/ZayanLambe13/puter-zayan/commit/256189a7def735dcbd571eedd10e083bd67a7dc0))
* shard apps as well to avoid hot partitions ([#1799](https://github.com/ZayanLambe13/puter-zayan/issues/1799)) ([435d266](https://github.com/ZayanLambe13/puter-zayan/commit/435d26608a07265b0142110c226976bfa889589f))
* support Gemini imagegen service ([e13b008](https://github.com/ZayanLambe13/puter-zayan/commit/e13b008c7910294fb9c591032db618b8d721c9c5))
* **Translation:** added support for Armenian and also added Bulgarian (Closes [#1523](https://github.com/ZayanLambe13/puter-zayan/issues/1523)) ([#1676](https://github.com/ZayanLambe13/puter-zayan/issues/1676)) ([3120d6a](https://github.com/ZayanLambe13/puter-zayan/commit/3120d6a057705b761878bd64c94257867a001372))
* ui for dev account + util decorators for controllers in extension ([#1864](https://github.com/ZayanLambe13/puter-zayan/issues/1864)) ([6037469](https://github.com/ZayanLambe13/puter-zayan/commit/603746951b8da41ccce9a5b9301e5dcc1e8b1508))
* **UI:** Differentiate tablet UI based on pointer capabilities ([#1482](https://github.com/ZayanLambe13/puter-zayan/issues/1482)) ([fb04c55](https://github.com/ZayanLambe13/puter-zayan/commit/fb04c55216737016fe1cdfa21c7e196f8f2ff58e))


### Bug Fixes

* according to jquery spec, this is more robust ([52d4ca6](https://github.com/ZayanLambe13/puter-zayan/commit/52d4ca6caf709955444065aadeeb02bacc00006c))
* add back non-functional changes ([#1888](https://github.com/ZayanLambe13/puter-zayan/issues/1888)) ([93aaeef](https://github.com/ZayanLambe13/puter-zayan/commit/93aaeef9e0b206289749e44c3a6cc1e83616890d))
* add Chinese transaltions ([#1559](https://github.com/ZayanLambe13/puter-zayan/issues/1559)) ([cab3d13](https://github.com/ZayanLambe13/puter-zayan/commit/cab3d130c713ac0f4d7d89a410b6bd63d8adbb1a))
* add Japanese translations ([#1519](https://github.com/ZayanLambe13/puter-zayan/issues/1519)) ([#1570](https://github.com/ZayanLambe13/puter-zayan/issues/1570)) ([42302b1](https://github.com/ZayanLambe13/puter-zayan/commit/42302b12acbb103ca38a841055b89450ed3066c9))
* add missing await in kv example extension ([9b34e67](https://github.com/ZayanLambe13/puter-zayan/commit/9b34e67d0da3162ad1ff03a90220e9f69659a922))
* add missing dep to whoami extension ([dabf8ca](https://github.com/ZayanLambe13/puter-zayan/commit/dabf8cac56004863c68dc95420854b7341719aae))
* add missing file ([a4d1855](https://github.com/ZayanLambe13/puter-zayan/commit/a4d1855b70fd62f29331b9fd8ff5771fa75d732b))
* add missing utilities.js ([39fdcec](https://github.com/ZayanLambe13/puter-zayan/commit/39fdcec9bf05858824f39978f18672d8e2662db1))
* add undefined check for gui metadata ([2954b62](https://github.com/ZayanLambe13/puter-zayan/commit/2954b6225b342f8cc71a5f20622c2a5149c9e99f))
* add unlink() methods to clear ECMAP ([7d7291c](https://github.com/ZayanLambe13/puter-zayan/commit/7d7291cde4c716dfd2c890338983d71722de797a))
* adding more benign changes ([#1891](https://github.com/ZayanLambe13/puter-zayan/issues/1891)) ([85432c8](https://github.com/ZayanLambe13/puter-zayan/commit/85432c886e838b9e2012dc08440e4b81b5d0a428))
* adjust toolbar positioning for sidepanel based on taskbar location ([#1731](https://github.com/ZayanLambe13/puter-zayan/issues/1731)) ([9607706](https://github.com/ZayanLambe13/puter-zayan/commit/9607706d11590c05f1f2393eaefc91487d53f0d6))
* **ai:** try overriding timeout to disable error ([1c64cb2](https://github.com/ZayanLambe13/puter-zayan/commit/1c64cb274b4ae556d6fe0201fbd85dc8a921b2ac))
* allow stripe header and commit db migration ([#1877](https://github.com/ZayanLambe13/puter-zayan/issues/1877)) ([71fb04c](https://github.com/ZayanLambe13/puter-zayan/commit/71fb04cd55130eae840ccfe8b2b3728f8b523037))
* alowance typo ([#1756](https://github.com/ZayanLambe13/puter-zayan/issues/1756)) ([b4cafaa](https://github.com/ZayanLambe13/puter-zayan/commit/b4cafaa5bb4c479edc02bf31fa9cdf23cfd4720f))
* APIErrors in entri service ([ba2609b](https://github.com/ZayanLambe13/puter-zayan/commit/ba2609be28bdb8175f302d7d82b7443a3d9d0070))
* app monthly usage details error ([#1761](https://github.com/ZayanLambe13/puter-zayan/issues/1761)) ([15b65da](https://github.com/ZayanLambe13/puter-zayan/commit/15b65dab7d75fe42151eb650bf598512a39acb4d))
* apparently setters shadow getting ([b328355](https://github.com/ZayanLambe13/puter-zayan/commit/b328355a907a045d7f4c13aa1636dbcbeea43178))
* backward compatibility for puter kv incr/decr ([#1697](https://github.com/ZayanLambe13/puter-zayan/issues/1697)) ([2a2a1f6](https://github.com/ZayanLambe13/puter-zayan/commit/2a2a1f6a99b6305f44d81b29aa81aafa7ed49aab))
* bad acl check returning early ([#1789](https://github.com/ZayanLambe13/puter-zayan/issues/1789)) ([760bc22](https://github.com/ZayanLambe13/puter-zayan/commit/760bc227430c3a7fe91054345cfbbc3ea2b6c199))
* bad amount of sql params ([#1879](https://github.com/ZayanLambe13/puter-zayan/issues/1879)) ([98cf4bb](https://github.com/ZayanLambe13/puter-zayan/commit/98cf4bbb081249cfa1d950e715853ded8f7f722c))
* bad amount of sql params ([#1880](https://github.com/ZayanLambe13/puter-zayan/issues/1880)) ([89a3a32](https://github.com/ZayanLambe13/puter-zayan/commit/89a3a3228f5bd1fe629bd98cf7464801261fef64))
* bad boolean check ([#1721](https://github.com/ZayanLambe13/puter-zayan/issues/1721)) ([5450c85](https://github.com/ZayanLambe13/puter-zayan/commit/5450c85b3a35840a0c3c73a1aa7fa1bd0b442284))
* bad math check for max consumed credits ([#1769](https://github.com/ZayanLambe13/puter-zayan/issues/1769)) ([c38da86](https://github.com/ZayanLambe13/puter-zayan/commit/c38da86293250d850c66693693849b759010eab7))
* bad naming ([#1878](https://github.com/ZayanLambe13/puter-zayan/issues/1878)) ([7085bcb](https://github.com/ZayanLambe13/puter-zayan/commit/7085bcbb93171eeaf8fc21ed969da1f5536e5547))
* bad null check ([#1770](https://github.com/ZayanLambe13/puter-zayan/issues/1770)) ([9bdb139](https://github.com/ZayanLambe13/puter-zayan/commit/9bdb139f7a82ef610e6beb76b91014ac530828a4))
* br.js transaltions ([6b05c90](https://github.com/ZayanLambe13/puter-zayan/commit/6b05c90a219ca555aa9a6fe305f1473c8274dafc))
* broken open ai moderation ([#1714](https://github.com/ZayanLambe13/puter-zayan/issues/1714)) ([3df1d31](https://github.com/ZayanLambe13/puter-zayan/commit/3df1d31a37b62ee0c7c245ef7ded482f8acae968))
* check if shraed files exist in ll_readshares ([baf261c](https://github.com/ZayanLambe13/puter-zayan/commit/baf261c0c4677cd2e69925467e68bee946e9c264))
* cleanup EngPortalService commands ([887536b](https://github.com/ZayanLambe13/puter-zayan/commit/887536b811920733f903966e969aa7057d64ac01)), closes [#1624](https://github.com/ZayanLambe13/puter-zayan/issues/1624)
* dbkv raw import ([#1848](https://github.com/ZayanLambe13/puter-zayan/issues/1848)) ([ff9932b](https://github.com/ZayanLambe13/puter-zayan/commit/ff9932b2f38d4e64de15937bcc410bc664d945f3))
* do not animate non-existing captcha modal ([ec50536](https://github.com/ZayanLambe13/puter-zayan/commit/ec505366e6e9bb46ca9279c91566557f51382ba4))
* don't set metadata until migration ([#1886](https://github.com/ZayanLambe13/puter-zayan/issues/1886)) ([823c06c](https://github.com/ZayanLambe13/puter-zayan/commit/823c06c371e0535405333be8b8b3f0ebb0e2d290))
* error logs are too verbose ([dc6a931](https://github.com/ZayanLambe13/puter-zayan/commit/dc6a931a237463c7cb6b1c8d1798f4a77d610a84))
* event multiplication introduced in ebf4d7 ([094dd18](https://github.com/ZayanLambe13/puter-zayan/commit/094dd183b298b40fe5ebc34e2f791ee85e76c7f3))
* expiry time for dbkv ([860f68a](https://github.com/ZayanLambe13/puter-zayan/commit/860f68a9a54616ef41279b16d9a5bbbcf3e97c71))
* **fs:** better errors for unresolved selectors ([7cc7907](https://github.com/ZayanLambe13/puter-zayan/commit/7cc79077d1833969b3460d2f881b212682e9a6db))
* get rid of a console log ([b1facfb](https://github.com/ZayanLambe13/puter-zayan/commit/b1facfbabd09c30b6516f68d61e4c52cc89408de))
* get rid of preflight for non-apifs readdir/stat ([8884c7f](https://github.com/ZayanLambe13/puter-zayan/commit/8884c7f472f936e18b213b98b4fb514e534c4a2e))
* **gui:** prevent background apps from stealing focus ([#1491](https://github.com/ZayanLambe13/puter-zayan/issues/1491)) ([cddfa0c](https://github.com/ZayanLambe13/puter-zayan/commit/cddfa0ca1152423078c163e483570075f0ed3845))
* I have no idea how I didn't catch this ([c40c138](https://github.com/ZayanLambe13/puter-zayan/commit/c40c138aa21db9a255b997e1aece4a9e6faf12bc))
* increment for non-existent keys ([#1649](https://github.com/ZayanLambe13/puter-zayan/issues/1649)) ([4a1aee0](https://github.com/ZayanLambe13/puter-zayan/commit/4a1aee0713cd0cc749e09502e4cf67998f7c6a54))
* is_empty sometimes being wrong ([3af84c0](https://github.com/ZayanLambe13/puter-zayan/commit/3af84c06470d482ae80246eef2c96b9e192cc94a))
* lessen alert triggering for metering ([#1837](https://github.com/ZayanLambe13/puter-zayan/issues/1837)) ([fd8a88b](https://github.com/ZayanLambe13/puter-zayan/commit/fd8a88b8f4bb784ff4f45ed38f0ce093418e95c6))
* make optimization for is_empty conditional ([6480d37](https://github.com/ZayanLambe13/puter-zayan/commit/6480d37ec03081592ddb0a45657d8a60c990dae3))
* metering service global write and open ai default model ([#1717](https://github.com/ZayanLambe13/puter-zayan/issues/1717)) ([eea27be](https://github.com/ZayanLambe13/puter-zayan/commit/eea27be8eb7874b26a471a8e8672efe9e9bb62ff))
* metering typos ([#1754](https://github.com/ZayanLambe13/puter-zayan/issues/1754)) ([24a51c5](https://github.com/ZayanLambe13/puter-zayan/commit/24a51c59aeffc388aaf30497d720ef6bc227a059))
* missing await in extension loader ([db5aef5](https://github.com/ZayanLambe13/puter-zayan/commit/db5aef51b042ce850af893418283959500c7b6e6))
* missing check for dev console service ([b6e1276](https://github.com/ZayanLambe13/puter-zayan/commit/b6e12762ce39e9387b9315f19a36a7b17ec1d70e))
* missing condition in ownership check ([c508189](https://github.com/ZayanLambe13/puter-zayan/commit/c508189455316853f82076ab3606a20e706ed718))
* missing return for app icons on init ([b92a4ed](https://github.com/ZayanLambe13/puter-zayan/commit/b92a4edb838cd38caaffe1492bcc7ba1b73d0281))
* missing span name ("fn is not defined" error) ([4d92f4a](https://github.com/ZayanLambe13/puter-zayan/commit/4d92f4a3ce78b93a80ce7908e734b5eee4ae8b0e))
* NaN value for consumedPurchaseCredits accounting ([#1767](https://github.com/ZayanLambe13/puter-zayan/issues/1767)) ([fc7a51b](https://github.com/ZayanLambe13/puter-zayan/commit/fc7a51bd2f700ed2ca5e1cdf06d58c4bdcbc181f))
* oops, it's not puter.config here ([d198e26](https://github.com/ZayanLambe13/puter-zayan/commit/d198e266298e8a59e3a8ce57a2edddf24424a3c7))
* openai configuration regression ([16e7fe9](https://github.com/ZayanLambe13/puter-zayan/commit/16e7fe985145a72469849b6da9221adf86e3d9b6))
* openrouter usage calculator ([#1725](https://github.com/ZayanLambe13/puter-zayan/issues/1725)) ([c0d96c7](https://github.com/ZayanLambe13/puter-zayan/commit/c0d96c7e97bab4d194f20743259bbc0dd8921532))
* options.no_options_auth should be optional chained ([44fcb58](https://github.com/ZayanLambe13/puter-zayan/commit/44fcb5800b3fed7fce0c1fd4ce67d6415114e58f))
* package name ([9d5a09f](https://github.com/ZayanLambe13/puter-zayan/commit/9d5a09f0bc7c4aa2499a900035941ec67dea4b5e))
* PayloadTooLargeError for JSON + base64 images ([b9f42f6](https://github.com/ZayanLambe13/puter-zayan/commit/b9f42f6daa723ee830de1531e8c52e17be3c9837))
* permission batch get ([#1637](https://github.com/ZayanLambe13/puter-zayan/issues/1637)) ([5b3bc9d](https://github.com/ZayanLambe13/puter-zayan/commit/5b3bc9ddf4b425cd660ede7938c611532423e036))
* permission writeback to flat kv perissions ([#1774](https://github.com/ZayanLambe13/puter-zayan/issues/1774)) ([686c2bc](https://github.com/ZayanLambe13/puter-zayan/commit/686c2bc966f799cd290fbb59089dfa244dac0c19))
* preflight issue with protected endpoints ([a5fa16b](https://github.com/ZayanLambe13/puter-zayan/commit/a5fa16b7bb322d22274eda2a87da7b196775fa53))
* prevent unnecessary updates on socket events ([ef74a1a](https://github.com/ZayanLambe13/puter-zayan/commit/ef74a1a660dddc88a6db0a2b1a24cc99e381e9bb))
* quick fix for config context issue ([0c06040](https://github.com/ZayanLambe13/puter-zayan/commit/0c06040e6cdbb1844f5522d8224a4a8b74d56bd8))
* read 'push' of undefined ([27ab23e](https://github.com/ZayanLambe13/puter-zayan/commit/27ab23e7b19f15d8ce1e0043184c9cdbe7e4d55e))
* Remove polluting logging in __all__.js ([b3191e3](https://github.com/ZayanLambe13/puter-zayan/commit/b3191e3b5d90e5f6fbd879ef1b25909ef34e9a21))
* remove unused AWS SDK v2 import ([4d8692f](https://github.com/ZayanLambe13/puter-zayan/commit/4d8692fd310b8ca2b374643b26499d52cbf7da9d))
* remove verbose parameters log ([44522f0](https://github.com/ZayanLambe13/puter-zayan/commit/44522f0a2259efcc53f7a90ee07c7c261f459610))
* selector handling from 8cfa0ece ([43a0be3](https://github.com/ZayanLambe13/puter-zayan/commit/43a0be33ca975e17528c311efce5c58d7eedf4de))
* simplify export import typedef ([#1818](https://github.com/ZayanLambe13/puter-zayan/issues/1818)) ([3fb3cf0](https://github.com/ZayanLambe13/puter-zayan/commit/3fb3cf0e60a40e486a320935628b24dca288ff4e))
* skip files with //!noprepend at the top ([709f544](https://github.com/ZayanLambe13/puter-zayan/commit/709f5444b2b88e04d4051a1b409e05c3b9a1a6b6))
* string coercion for email verify code ([ef76d33](https://github.com/ZayanLambe13/puter-zayan/commit/ef76d33cc2d9100e471cceaaf99a372750ad8ace))
* support async iterator for AI chat streaming mode in types ([1affbb4](https://github.com/ZayanLambe13/puter-zayan/commit/1affbb4cc860eeed2702380c2538a8fcb06cb893))
* Switch to new OpenAI Moderation model ([#1826](https://github.com/ZayanLambe13/puter-zayan/issues/1826)) ([20601ce](https://github.com/ZayanLambe13/puter-zayan/commit/20601ce5e4b953a5787e83677919425a519714b1))
* system actor for extension lifecycle events ([9ff59d9](https://github.com/ZayanLambe13/puter-zayan/commit/9ff59d92902bc54aef1c0f8359a79b5c6a123599))
* third times the charm ([8c2e459](https://github.com/ZayanLambe13/puter-zayan/commit/8c2e459f3c56fadb3539d0886b9fd11e0c7af855))
* throw error not lorem when moderation fails ([5b16774](https://github.com/ZayanLambe13/puter-zayan/commit/5b16774a9a8007fcdcf8978a3302e5951883ad52))
* try disabling this 30 second app cache for now ([f98c785](https://github.com/ZayanLambe13/puter-zayan/commit/f98c78504b4796e8cd15feda4c539d840cddd446))
* try skipping any directory in extensions named gui ([7dfb05f](https://github.com/ZayanLambe13/puter-zayan/commit/7dfb05f589d2813911fe2064ec927060907e5510))
* ts issue when building for deploy ([#1890](https://github.com/ZayanLambe13/puter-zayan/issues/1890)) ([11d2515](https://github.com/ZayanLambe13/puter-zayan/commit/11d2515cb283bba0cf9d12610170d9b751d28f20))
* typedefs ([44284eb](https://github.com/ZayanLambe13/puter-zayan/commit/44284eb7881085cb3132d347b912f8102adb33de))
* undefined alias array ([#1709](https://github.com/ZayanLambe13/puter-zayan/issues/1709)) ([248b38e](https://github.com/ZayanLambe13/puter-zayan/commit/248b38e732264b40b9d5c3e62770b753d1a3a5cb))
* update path when renaming during save_account ([088ff4d](https://github.com/ZayanLambe13/puter-zayan/commit/088ff4d69657060e3cecc93f431fd1816d320138))
* usage limited issue whens treaming ([#1806](https://github.com/ZayanLambe13/puter-zayan/issues/1806)) ([c9ab01c](https://github.com/ZayanLambe13/puter-zayan/commit/c9ab01cf1ef42c43f8e3ed156be8f16e4a5ff5e8))
* Use APIErrror.create in place of newAPIError ([ecff560](https://github.com/ZayanLambe13/puter-zayan/commit/ecff560480f5922cda8dafc91a3e66084a99f6e6))
* use correct API error in entri-service ([7e0b8c6](https://github.com/ZayanLambe13/puter-zayan/commit/7e0b8c66c40a0b99e4d5cb686a022f9eeaf19173))
* use dynamic import for dotenv ([f729eaa](https://github.com/ZayanLambe13/puter-zayan/commit/f729eaa31fe10e6b772c82ec5611002baead1994))
* webdav MOVE/COPY escaping bug ([72e66da](https://github.com/ZayanLambe13/puter-zayan/commit/72e66da8a12e79a503c01ae64829ddf08cf32019))


### Performance Improvements

* add 30 second app cache ([f3fdfea](https://github.com/ZayanLambe13/puter-zayan/commit/f3fdfea65b37783ce9bb8817e91e33969192a480))
* add some new keys to initial fetch ([e926738](https://github.com/ZayanLambe13/puter-zayan/commit/e926738d64089433d12f59fddf5c4987716aad5d))
* always shortcut is-owner implicator ([b8354cc](https://github.com/ZayanLambe13/puter-zayan/commit/b8354cc4a607df9bc168c7fc8caac7c1b5dae840))
* avoid reduntant fetches due to concurrency ([c70434d](https://github.com/ZayanLambe13/puter-zayan/commit/c70434d9474bc395ecb0c22eb459c10765024a22))
* execution context memoization map for filesystem ([b3e2b69](https://github.com/ZayanLambe13/puter-zayan/commit/b3e2b69c4dc56e9a51c57ef91f89ea8395fa82c2))
* fix sequential kv gets for default apps ([7bc03fe](https://github.com/ZayanLambe13/puter-zayan/commit/7bc03fe17c339af068a4bd03c8f35503978d71bf))
* further readdir improvements ([733b6a6](https://github.com/ZayanLambe13/puter-zayan/commit/733b6a653efe23d627074dd4bc2d4e57a8776129))
* huh, right... not sure how I missed that ([42abfcc](https://github.com/ZayanLambe13/puter-zayan/commit/42abfcc5e756eb5a2a481c0cea2104f062beafa2))
* **kernel:** parallelize extension installation ([48982ca](https://github.com/ZayanLambe13/puter-zayan/commit/48982cac8418f76f0e2385f434aa552a4d25f121))
* make stat really fast ([a588288](https://github.com/ZayanLambe13/puter-zayan/commit/a5882889ddcde67e64b0a06216288775f598a400))
* move user-user perm checks to flat kv entries ([#1562](https://github.com/ZayanLambe13/puter-zayan/issues/1562)) ([9c47a7f](https://github.com/ZayanLambe13/puter-zayan/commit/9c47a7f8caaa20521404285758bd6ecf06317e8e))
* naive permission cache ([9582297](https://github.com/ZayanLambe13/puter-zayan/commit/958229754744fc3d1f8527e046cc8973caa8ac33))
* optimize extension loader ([7872fd5](https://github.com/ZayanLambe13/puter-zayan/commit/7872fd58ed4643adc095aab3e232a51890926bc6))
* skip quick_check for only one provider ([6a129ba](https://github.com/ZayanLambe13/puter-zayan/commit/6a129ba8ccecf3dd537fc04b4fbf80c5d2bed4f2))


### Reverts

* commits for user metadata changes ([#1887](https://github.com/ZayanLambe13/puter-zayan/issues/1887)) ([758bef0](https://github.com/ZayanLambe13/puter-zayan/commit/758bef0582f3f674541f39591d0bce0ed3d2855b))
* eslint config rules ([#1625](https://github.com/ZayanLambe13/puter-zayan/issues/1625)) ([3fc1832](https://github.com/ZayanLambe13/puter-zayan/commit/3fc183297fb3740883ad8a20da73b055be3a17f7))
* fs metering ([#1790](https://github.com/ZayanLambe13/puter-zayan/issues/1790)) ([4b14ef8](https://github.com/ZayanLambe13/puter-zayan/commit/4b14ef863c436eaedcdbf14c2cf98a47ce573157))
* revert devex changes  ([#1728](https://github.com/ZayanLambe13/puter-zayan/issues/1728)) ([fc725d0](https://github.com/ZayanLambe13/puter-zayan/commit/fc725d0130b1ddfd888d1feceab3f718b297b729))
